                ...
                <div className="flex-1 flex-col pb-2">
                  ...
                  <div className="flex w-full items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <button className="rounded-md bg-blue-500 px-3 py-1.5 text-sm font-semibold text-white hover:bg-blue-600 focus:outline-none">
            ...
            <div className="col-span-2 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4 rounded-lg bg-white p-3 text-gray-600 shadow dark:bg-neutral-800">
                <div className="flex items-center justify-between">
                  ...
                  <a className="cursor-pointer text-sm text-blue-500 hover:underline">
                    See all photos
                  </a>
                </div>
